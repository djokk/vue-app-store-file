<template>
  <div>
    <div v-if="productsLoading" class="content container">Загрузка....</div>
    <div v-else-if="!productData" class="content container">Ошибка при загрузке товара.... <button @click.prevent="loadProduct()">Попробовать ещё раз</button></div>
        ...
        <div class="item__info">
          ...
          <div class="item__form">
            <form class="form" action="#" method="POST" @submit.prevent="addToCart">
              <p class="item__price">{{ product.price | numberFormat }} ₽</p>
              ...
              <div class="item__row">
                ...
                <button class="button button--primery" type="submit" :disabled="productsAddSending">В корзину</button>
              </div>
              <div v-if="productsAdded">Товар добавлен в корзину</div>
              <div v-if="productsAddSending">Добавляем товар в корзину...</div>
            </form>
          </div>
        </div>
        ...
        <div class="item__desc">
          ...
          <div class="item__content">
            ...
            <p>
              ...
              мобильное устройство можно установить как фирменное приложение, так и
            ...
            <p>
              ...
              скорость, а также полученная со смартфона и синхронизированных датчиков
              информация: интенсивность, скорость вращения педалей, пульс и т.д. (датчики не
              входят в комплект поставки). Корпус велокомпьютера имеет степень защиты от
...
export default {
  ...
  methods: {
    ...
    minus() {
      if (this.productAmount !== 0) this.productAmount -= 1;
    },
    loadProduct() {
